...
(async () => {
    ...
    if (mw.config.get("wgUserName") !== "星海子") { return; }
    ...
    const container = $("<div class=\"AnnTools_Frame\" style=\"display: none;\"><div class=\"AnnTools_Frame_Head\"><div class=\"AnnTools_Frame_Title\">公共讨论页段落状态标记工具</div><span class=\"AnnTools_Frame_Close\">×</span></div><div class=\"AnnTools_Frame_Content\"><div class=\"AnnTools_Confirm\" id=\"AnnTools_Confirm_First\"><div class=\"AnnTools_Confirm_Content\">请问你是要标记这个段落吗？<br>段落标题：<span class=\"AnnTools_SectionTitle\"></span></div><div class=\"AnnTools_Confirm_Yes\">是呀是呀</div><div class=\"AnnTools_Confirm_No\">并不是呢</div></div><div class=\"AnnTools_Confirm AnnTools_Confirm_expand\" id=\"AnnTools_Confirm_Second\"><div class=\"AnnTools_Confirm_Content\">请问你想标记这个段落为什么状态？<br>段落标题：<span class=\"AnnTools_SectionTitle\"></span><dl><dt>状态：</dt><dd><ul class=\"AnnTools_form\"><li><input class=\"AnnTools_radio\" value=\"r\" id=\"AnnTools_radio_r\" type=\"radio\" checked=\"checked\"><label for=\"AnnTools_radio_r\">问题已解决</label></li><li><input class=\"AnnTools_radio\" value=\"p\" id=\"AnnTools_radio_p\" type=\"radio\"><label for=\"AnnTools_radio_p\">问题已答复</label></li><li><input class=\"AnnTools_radio\" value=\"a\" id=\"AnnTools_radio_a\" type=\"radio\"><label for=\"AnnTools_radio_a\">请求已接受</label></li><li><input class=\"AnnTools_radio\" value=\"s\" id=\"AnnTools_radio_s\" type=\"radio\"><label for=\"AnnTools_radio_s\">请求被暂缓</label></li><li><input class=\"AnnTools_radio\" value=\"w\" id=\"AnnTools_radio_w\" type=\"radio\" ><label for=\"AnnTools_radio_w\">请求被撤回</label></li><li><input class=\"AnnTools_radio\" value=\"c\" id=\"AnnTools_radio_c\" type=\"radio\"><label for=\"AnnTools_radio_c\">注销进行中</label></li><li><input class=\"AnnTools_radio\" value=\"n\" id=\"AnnTools_radio_n\" type=\"radio\"><label for=\"AnnTools_radio_n\">无人回复<s>（点名批评）</s></label></li><li><input class=\"AnnTools_radio\" value=\"d\" id=\"AnnTools_radio_d\" type=\"radio\"><label for=\"AnnTools_radio_d\">请求被拒绝</label></li></ul></dd><dt>存档用时：</dt><dd><input id=\"AnnTools_archive_offset\" type=\"number\" min=\"1\" max=\"30\" step=\"1\" list=\"AnnTools_archive_offset_datalist\"><datalist id=\"AnnTools_archive_offset_datalist\"><option value=\"1\"><option value=\"3\"><option value=\"10\"><option value=\"30\"></datalist></dd><dt>前置留言：</dt><dd><input id=\"AnnTools_precomment\" type=\"text\" size=\"255\" placeholder=\"（但是如果不写就啥也没有）\"></dd><dt>留言：</dt><dd><input id=\"AnnTools_comment\" type=\"text\" size=\"255\" placeholder=\"（但是如果不写就啥也没有）\"></dd></dl></div><div class=\"AnnTools_Confirm_Yes\">就是这样</div><div class=\"AnnTools_Confirm_No\">我再想想</div><div class=\"AnnTools_status\"></div></div></div></div>").appendTo("body");
